  ...
  return (
    <div className="relative">
      ...
      >
        ...
        />
        <Card 
        className={`shadow-2xl border border-border/50 dark:border-border/60 ring-1 ring-border/40 dark:ring-border/60 rounded-3xl bg-card ${isCommenting ? 'h-auto' : 'min-h-[420px] max-h-[520px] sm:min-h-[440px] sm:max-h-[580px]'} flex flex-col overflow-hidden relative`}
    ...
    <Card 
      className={`shadow-2xl border border-border/50 dark:border-border/60 ring-1 ring-border/40 dark:ring-border/60 rounded-3xl bg-card ${isCommenting ? 'h-auto' : 'min-h-[420px] max-h-[520px] sm:min-h-[440px] sm:max-h-[580px]'} flex flex-col overflow-hidden absolute inset-0`} 
      style={{
        transformStyle: "preserve-3d",
        backfaceVisibility: "hidden",
