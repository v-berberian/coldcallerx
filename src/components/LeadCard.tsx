        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-24 justify-center">
            <Button 
              ...
              size="lg" 
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-full shadow-lg bg-[#007AFF] hover:bg-[#0066CC] active:bg-[#005BB5] text-white transition-colors duration-200 flex items-center justify-center p-0"
            >
            ...
            <Button 
              onClick={handleCall} 
              size="lg" 
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-full shadow-lg bg-green-500 hover:bg-green-600 active:bg-green-700 text-white transition-colors duration-200 flex items-center justify-center p-0"
            >
