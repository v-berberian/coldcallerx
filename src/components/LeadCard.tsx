...
const LeadCard: React.FC<LeadCardProps> = ({
  ...
  return (
    <Card key={cardKey} className="shadow-2xl rounded-3xl bg-card h-[400px] flex flex-col animate-scale-in border-0">
      <CardContent className="p-6 space-y-4 flex-1 flex flex-col">
        ...
        <Button onClick={onCall} size="lg" className="w-full h-16 text-lg font-semibold bg-green-600 hover:bg-green-700 text-white rounded-2xl shadow-lg border-0">
