...
const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <div className={`flex-1 flex items-start justify-center pt-1 min-h-0 transition-all duration-300 ${isCommenting ? 'p-1' : 'p-3 sm:p-4'}`} style={{ minHeight: 'calc(100dvh - 120px)' }}>
