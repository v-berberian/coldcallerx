...
const SearchAutocomplete: React.FC<SearchAutocompleteProps> = ({ 
  ...
  if (leads.length === 0) {
    return (
      <div className={`absolute top-full left-0 right-0 z-50 mt-1 p-4 text-center text-muted-foreground rounded-xl shadow-lg ${animationClass} bg-background/30 backdrop-blur-md border border-border/20`}>
        No leads found
      </div>
    );
  }
